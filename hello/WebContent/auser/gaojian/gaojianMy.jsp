...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function gaojianDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/gaojian?type=gaojianDel&id="+id;
               }
           }
           
           function gaojianAdd()
           {
                 var url="<%=path %>/auser/gaojian/gaojianAdd.jsp";
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align="center" bgcolor="#FAFAF1" height="22">
					...
					<td width="6%">专家审核信息</td>
					<td width="6%">主编审核信息</td>
					<td width="6%">操作</td>
		        </tr>	
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<c:if test="${gaojian.zhubianshenhebiaozhi=='shenhetongguo'}">
						    主编审核通过(审核意见：${gaojian.zhubianshenheyijian})
						</c:if>
						<c:if test="${gaojian.zhubianshenhebiaozhi=='shenhetongguono'}">
						    主编审核未通过(审核意见：${gaojian.zhubianshenheyijian})
						</c:if>
					</td>
					<td bgcolor="#FFFFFF" align="center">
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 5px;">
			  <tr>
			    <td>
			      <input type="button" value="添加" style="width: 80px;" onclick="gaojianAdd()" />
			    </td>
			  </tr>
		    </table>
	</body>
