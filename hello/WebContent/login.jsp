...
<head>
 ...
 function reg()
 {
     ...
     pop.setContent("contentUrl","<%=path %>/userReg.jsp");
...
<body>
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 33pt;">JSP网上投稿系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					...
					<tr style="display: block">
					    <td height="31" colspan="2" valign="top" class="STYLE15">
					         身份：
					         <select class="INPUT_text" name="userType" style="width: 133px;">
					...
					<tr>
						<td colspan="2" valign="top">&nbsp; &nbsp; &nbsp; &nbsp;
							...
							<input name="button1" type="button" class="submit1" value="注册" onclick="reg()">
