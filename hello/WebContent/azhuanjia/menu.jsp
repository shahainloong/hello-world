	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>稿件审核</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	               <li><a href='<%=path %>/gaojian?type=gaojianDaishen_zhuanjia' target='main'>待审核---稿件</a> </li>
	               <li><a href='<%=path %>/gaojian?type=gaojianYishen_zhuanjia' target='main'>已审核---稿件</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
