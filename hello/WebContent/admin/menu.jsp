	    ...
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	                    <li><a href='<%=path %>/user?type=userMana' target='main'>注册用户管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>专家信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	                    <li><a href='<%=path %>/zhuanjia?type=zhuanjiaMana' target='main'>专家信息管理</a> </li>
	                    <li><a href='<%=path %>/admin/zhuanjia/zhuanjiaAdd.jsp' target='main'>专家信息添加</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>稿件信息审核</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	               <li><a href='<%=path %>/gaojian?type=gaojianDaishen_admin' target='main'>待审核---稿件</a> </li>
	               <li><a href='<%=path %>/gaojian?type=gaojianYishen_admin' target='main'>已审核---稿件</a> </li>
	          </ul>
	        </dd>
	      </dl>
	     <%--  <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	               <li><a href='<%=path %>/admin/gaofei/gaofeiAdd.jsp' target='main'>稿费信息添加</a> </li>
